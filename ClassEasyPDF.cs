...
//    public LineDashStyle(unitsOn, phase) : this(new float[] { unitsOn, unitsOn }, phase)
//    {
//    }
//    public LineDashStyle(unitsOn, unitsOff, phase) : this(new float[] { unitsOn, unitsOff }, phase)
//    {
//    }
//    public LineDashStyle(float[] array, phase)
//    {
//        if (array == null)
//            throw new ArgumentNullException();
//        _array = array;
...
//        }
//    }
//    public float[] MultipliedArray(object multiplier)
//    {
//        float[] x = (float[])_array.Clone();
...
//        }
//    }
//    public float MultipliedPhase(object multiplier)
//    {
//        return _phase * multiplier;
//    }

//    public static readonly LineDashStyle Solid = new LineDashStyle(new float[] { }, 0);
//    public static readonly LineDashStyle Dash = new LineDashStyle(6, 6, 3);
//    public static readonly LineDashStyle Dot = new LineDashStyle(2, 3, 0);
//    public static readonly LineDashStyle DashDotDot = new LineDashStyle(new float[] { 6, 3, 2, 3, 2, 3 }, 0);
//}
...
//    }
//    public PDFWriter(System.IO.Stream s)
//    {
//        _Stream = s;
//    }
...
//    private Printing.PaperSize _GetPaperSize(Printing.PaperKind paperKind)
//    {
//        switch (paperKind) {
//            case object _ when Printing.PaperKind.Letter: {
//                    return new Printing.PaperSize(paperKind.ToString, 850, 1100);
//                }

//            case object _ when Printing.PaperKind.Legal: {
//                    return new Printing.PaperSize(paperKind.ToString, 850, 1400);
//                }

//            case object _ when Printing.PaperKind.Ledger: {
//                    return new Printing.PaperSize(paperKind.ToString, 1100, 1700);
//                }
...
//    public void NewPage(Drawing.Printing.PaperKind paperKind, bool landscape)
//    {
//        NewPage(_GetPaperSize(paperKind), landscape);
//    }
//    public void NewPage(Drawing.Printing.PaperKind paperKind, bool landscape, object marginLeft, object marginTop)
//    {
//        NewPage(_GetPaperSize(paperKind), landscape, marginLeft, marginTop);
//    }
//    public void NewPage(Drawing.Printing.PaperKind paperKind, bool landscape, Drawing.Printing.Margins m)
//    {
//        NewPage(_GetPaperSize(paperKind), landscape, m);
//    }

//    public void NewPage(object width, object height, bool Landscape)
//    {
//        NewPageAbs(_Translate(width), _Translate(height), 0, 0, Landscape);
//    }
//    public void NewPage(object width, object height, bool Landscape, object marginLeft, object marginTop)
//    {
//        NewPageAbs(_Translate(width), _Translate(height), _Translate(marginLeft), _Translate(marginTop), Landscape);
//    }

//    public void NewPage(Drawing.Printing.PaperSize ps, bool Landscape)
//    {
//        NewPageAbs(_Translate(ps.Width, ScaleModes.Hundredths), _Translate(ps.Height, ScaleModes.Hundredths), 0, 0, Landscape);
//    }
//    public void NewPage(Drawing.Printing.PaperSize ps, bool Landscape, float MarginLeft, float MarginTop)
//    {
//        NewPageAbs(_Translate(ps.Width, ScaleModes.Hundredths), _Translate(ps.Height, ScaleModes.Hundredths), _Translate(MarginLeft), _Translate(MarginTop), Landscape);
//    }
//    public void NewPage(Drawing.Printing.PaperSize ps, bool Landscape, Drawing.Printing.Margins m)
//    {
//        NewPageAbs(_Translate(ps.Width, ScaleModes.Hundredths), _Translate(ps.Height, ScaleModes.Hundredths), _Translate(m.Left, ScaleModes.Hundredths), _Translate(m.Top, ScaleModes.Hundredths), Landscape);
//    }
//    // Private Sub NewPageAbs(ByVal PageWidth As Single, ByVal PageHeight As Single, ByVal MarginLeft As Single, ByVal MarginRight As Single, ByVal MarginTop As Single, ByVal MarginBottom As Single)
...
//            // MarginLeft, MarginRight, MarginTop, MarginBottom)
//            if (Landscape)
//                _Document = new Document(new iTextSharp.text.Rectangle(PageWidth, PageHeight).Rotate);
//            else
//                _Document = new Document(new iTextSharp.text.Rectangle(PageWidth, PageHeight));
//            _Writer = iTextSharp.text.pdf.PdfWriter.GetInstance(_Document, _Stream);
//            _Document.Open();
...
//    public byte[] ToArray()
//    {
//        if (_Stream is not System.IO.MemoryStream)
//            throw new InvalidOperationException();
//        Close();
//        return (System.IO.MemoryStream)_Stream.ToArray();
//    }
//    public void Close() // closes underlying stream
//    {
//        if (_Content != null)
...
//        }
//    }
//    private double _Translate(double num)
//    {
//        return _Translate(num, _ScaleMode);
//    }
//    private static double _Translate(double num, ScaleModes scaleMode)
//    {
//        switch (scaleMode) {
//            case ScaleModes.Points: {
//                    return num;
...
//        }
//    }
//    private double _TranslateRev(double num)
//    {
//        return _TranslateRev(num, ScaleMode);
//    }
//    private static double _TranslateRev(double num, ScaleModes scaleMode)
//    {
//        switch (scaleMode) {
//            case ScaleModes.Points: {
//                    return num;
...
//            case ScaleModes.Hundredths: {
//                    return num * 100 / (double)72;
//                }

//            case ScaleModes.Inches: {
//                    return num / (double)72;
//                }
...
//    private iTextSharp.text.Font _GetFont(Font font)
//    {
//        if (font == null)
//            throw new InvalidOperationException();
//        iTextSharp.text.Font f;
...
//        if (font.Strikeout)
//            s = s | iTextSharp.text.Font.STRIKETHRU;
//        f = FontFactory.GetFont(Font.Name, BaseFont.CP1252, true, Font.SizeInPoints, s, _GetColor(ForeColor));
//        return f;
//    }
//}
